...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let appleIndex = 0 
    //Diseño serpiente
    let currentSnake = [2,1,0] //Cabeza, cuerpo, cola
    //Variables configuracion juego
    let direction = 1
    let score = 0
    let speed = 0.9
    let intervalTime = 0
    ...
    //Funcion para inciar o reiniciar el juego
    function startGame() {
    ...
    //Función que se ocupa de TODOS los resultados de la serpiente
    function moveOutcomes() {
      ...
      const tail = currentSnake.pop() //Elimina el último elemento de la matriz y lo muestra
      ...
      //Se ocupa de la serpiente que consigue la manzana
      //Aumentar el tamaño y score al momento de comer una manzana
    ...
    function randomApple() {
      do{
        appleIndex = Math.floor(Math.random() * squares.length)//Ubicacion random de la manzana
